...
-   Delve into a *comprehensive analysis* that connects environmental politics, sustainable practices, and advanced computational methods: <br> [View My Final Presentation](docs/Final_Project.html) <br>
-   Discover a *brief overview* of the critical insights and conclusions of my study: <br> [Access My Memo Presentation](docs/memo_Project.html)

## **Senior Thesis**

:::::: columns
**The Green Influence:** <br> **Exploring the Impact of Political Systems on Renewable Energy Transition in Oil Countries**
